...
class _$UpdateUserImpl implements _UpdateUser {
  const _$UpdateUserImpl(this.model, this.id);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return updateUser?.call(model, id);
  }
...
abstract class _UpdateUser implements UpdateUserEvent {
  const factory _UpdateUser(final UserRequestModel model, final int id) =
      _$UpdateUserImpl;
